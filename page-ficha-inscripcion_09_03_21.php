                                                            ...
                                                            <div class="fleft middle firstMiddle">
                                                                ...
                                                                <div>
                                                                    <div>
                                                                        ...
                                                                        <div><input id="idNumber" type="text"
                                                                                    class="idNumberInput"/></div>
                                                                    </div>
                                                                    <div id="idNumberError" class="error"
...
Acepto la <a href="https://www.lesmillsargentina.com.ar/politica-de-privacidad-2/">política de privacidad de datos personales</a>.
                                                ...
                                                <p class="nodisplay"><!-- end of stepInit --></p>


                                                <div id="stepConfirmName" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            <input id="confirmNameEventId" name="eventId" type="hidden"
                                                                   value=""/>
                                                            <input id="confirmNamePersonId" name="personId"
                                                                   type="hidden"/>
                                                            ...
                                                            <div>
                                                                El email registrado es <b id="confirmPersonMail">.
                                                            </div>
                                                            <div>
                                                    ...
                                                    <div class="clearfix buttonPosition">
                                                        <a href="#" class="button right" id="cancelStepConfirmName">Cancelar</a><a
                                                            href="#" class="button right" id="continueStepConfirmName">Continuar</a>
                                                    </div>

                                                </div>
                                                <p class="nodisplay"><!-- end of stepConfirmName --></p>


                                                <div id="stepRegister" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div>
                                                            <input id="registerEventId" name="eventId" type="hidden"
                                                                   value=""/>
                                                            ...
                                                            <div class="fleft middle firstMiddle">
                                                                <div>
                                                                    <label>Nombre *</label>
                                                                    <input class="medium" name="name" id="registerName"
                                                                           type="text"/>

                                                                    <div id="registerNameError" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                                <div>
                                                                    <label>Apellido *</label>
                                                                    <input class="medium" name="lastname"
                                                                           id="registerLastName" type="text"/>

                                                                    <div id="registerLastNameError" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                                <div><label>DNI</label>

                                                                    <div>
                                                                        <input id="registerIdNumberText" type="text"
                                                                               class="idNumberInput"
                                                                               disabled="disabled"/>
                                                                        <input id="registerIdNumber" type="hidden"/>
                                                                        <input id="registerIdNumberTypeId"
                                                                               type="hidden"/>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div class="radioContainer">
                                                                        <input id="registerGenderFemale" value="F"
                                                                               class="registerGender" type="radio"
                                                                               checked="checked" name="registerGender"/>
                                                                        Femenino
                                                                        <input id="registerGenderMasc" value="M"
                                                                               class="registerGender" type="radio"
                                                                               name="registerGender"/> Masculino
                                                                    </div>
                                                                </div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <div id="registerCUITError" class="error"
                                                                         style="display:none"></div>
                                                                </div>

                                                                <div>
                                                                    <label for="birthDate">Fecha de nacimiento *</label>
                                                                    <input class="isDatePicker small"
                                                                           id="registerBirthDate" type="text"/>

                                                                    <div id="registerBirthDateError" class="error"
                                                                         style="display:none"></div>
                                                                </div>

                                                                <div>
                                                                    <label for="nationality">Nacionalidad *</label>
                                                                    <input class="small" id="registerNationality"
                                                                           type="text"/>

                                                                    <div id="registerNationalityError" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                                <div>
                                                                    <label for="registerAddress">Dirección *</label>
                                                                    <input name="registerAddress" id="registerAddress"
                                                                           type="text"/>

                                                                    <div id="registerAddressError" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                                ...
                                                                <div>
                                                                    <label for="registerPostalCode">Código Postal
                                                                        *</label>
                                                                    <input name="registerPostalCode"
                                                                           id="registerPostalCode" type="text"/>

                                                                    <div id="registerPostalCodeError" class="error"
                                                                         style="display:none"></div>
                                                                </div>

                                                                <div class="region-container">
                                                                    <label>Pais, Estado, Ciudad, Localidad *</label>

                                                                    <div class="search">
                                                                        <a href="#" class="icon" title="Buscar"></a>
                                                                        <input id="registerRegionSearch" type="text"/>
                                                                        <input id="registerRegionSearchCheck"
                                                                               type="hidden">
                                                                    ...
                                                                    <div id="registerRegionError" class="error"
                                                                         style="display:none"></div>

                                                                </div>
                                                                <div>
                                                                    <label for="mobile">Celular *</label>
                                                                    <input class="small" id="registerMobile"
                                                                           type="text"/>

                                                                    <div id="registerMobileError" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                            </div>
                                                            <div class="fleft middle">
                                                                <div>
                                                                    ...
                                                                    <input class="small" id="registerPhoneNumber1"
                                                                           type="text"/>
                                                                </div>
                                                                <div>
                                                                    <label for="CommercialTelephone">Tel.
                                                                        comercial</label>
                                                                    <input class="small" id="registerPhoneNumber2"
                                                                           type="text"/>
                                                                </div>
                                                                <div>
                                                                    <label for="mobile">Nextel</label>
                                                                    <input class="small" id="registerNextel"
                                                                           type="text"/>
                                                                </div>
                                                                <div>
                                                                    <label for="mobile">Skype</label>
                                                                    <input class="small" id="registerSkype"
                                                                           type="text"/>
                                                                </div>
                                                                <div>
                                                                    <label for="mobile">Fax</label>
                                                                    <input class="small" id="registerFaxNumber"
                                                                           type="text"/>
                                                                </div>
                                                                <div>
                                                                    <label for="email">Email Principal *</label>
                                                                    <input id="registerEmail1" type="text"/>

                                                                    <div id="registerEmail1Error" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                                <div>
                                                                    ...
                                                                    <div id="registerEmail2Error" class="error"
                                                                         style="display:none"></div>
                                                                </div>
                                                                <div>
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input class="small" id="registerFacebook"
                                                                           type="text"/>
                                                                </div>
                                                                <div>
                                                                    <label for="email">Twitter</label>
                                                                    <input class="small" id="registerTwitter"
                                                                           type="text"/>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    ...
                                                    <div class="clearfix buttonPosition">
                                                        <a href="#" class="button right" id="cancelStepRegister">Cancelar</a><a
                                                            href="#" class="button right" id="continueStepRegister">Continuar</a>
                                                    </div>

                                                </div>
                                                <p class="nodisplay"><!-- end of stepConfirmName --></p>

                                                <div id="stepConfirmGymName" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            ...
                                                            <div>
                                                                ...
                                                                <input class="medium" name="name"
                                                                       id="confirmGymNameName" type="text"/>

                                                                <div>
                                                                    <input class="medium" name="name"
                                                                           id="confirmGymNameIsAutonomo"
                                                                           onchange="confirmGymNameIsAutonomoChange()"
                                                                           type="checkbox"/>
                                                                    <span>Soy Autónomo</span>
                                                                </div>
                                                                <div id="confirmGymNameNameError" class="error"
                                                                     style="display:none"></div>
                                                            </div>
                                                            <div>
                                                                <label>Nombre del responsable</label>
                                                                <input class="medium" name="name"
                                                                       id="confirmGymNameResponsible" type="text"/>

                                                                <div id="confirmGymNameResponsibleError" class="error"
                                                                     style="display:none"></div>
                                                            </div>
                                                            <div>
                                                                <label>Teléfono del responsable</label>
                                                                <input class="medium" name="name"
                                                                       id="confirmGymNamePhone" type="text"/>

                                                                <div id="confirmGymNamePhoneError" class="error"
                                                                     style="display:none"></div>
                                                            </div>
                                                    ...
                                                    <div class="clearfix buttonPosition">
                                                        <a href="#" class="button right"
                                                           id="continueStepConfirmGymName">Continuar</a>
                                                    </div>
                                                ...
                                                <div id="stepAlreadyEnrolled" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            <div>
                                                ...
                                                <p class="nodisplay"><!-- end of stepAlreadyEnrolled --></p>

                                                <div id="stepValidateEmail" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        ...
                                                        <div>
                                                            <label>Email</label>
                                                            <input class="medium" id="validateEmailEmail" type="text"/>

                                                            <div id="validateEmailEmailError" class="error"
                                                                 style="display:none"></div>
                                                        </div>
                                                    </div>
                                                    <div class="clearfix buttonPosition">
                                                ...
                                                <div id="stepShowCheckMailBox" class="filter enrollmentStep messageStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            <div>
                                                                Hemos enviado un email a su casilla de correo: <b
                                                                    id="checkMailBoxMail"></b>.
                                                            </div>
                                                            <div>
                                                ...
                                                <div id="stepShowActivationCodeUsed"
                                                     class="filter enrollmentStep messageStep" style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            <div>
                                                ...
                                                <div id="stepNoValidParticipant" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            <div>
                                                ...
                                                <div id="stepConfirmPrograms" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            <input id="confirmProgramsParticipantId" name="personId"
                                                                   type="hidden"/>
                                                            <input id="confirmProgramsToken" type="hidden"/>

                                                            <div class="programsContainer">
                                                                <label>Seleccione los programas a inscribirse</label>

                                                                <div id="stepConfirmProgamsSelections">
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BP"/><img alt="BODYPUMP"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-pump.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BA"/><img alt="BODYATTACK"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-attack.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BC"/><img alt="BODYCOMBAT"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-combat.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BV"/><img alt="BODYVIVE"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-vive.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BB"/><img alt="BODYBALANCE"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-balance.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="RPM"/><img alt="RPM"
                                                                                                  src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-rpm.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BJ"/><img alt="BODYJAM"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-jam.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="SH"/><img alt="SH'BAM"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-shbam.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="BS"/><img alt="BODYSTEP"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-step.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection"
                                                                                value="CX"/><img alt="CXWORX"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-cxworx.jpg" ?>">
                                                                    </div>
                                                                    <div><input type="checkbox"
                                                                                name="programSelection[]"
                                                                                class="programSelection pjSelection"
                                                                                value="PJ"/><img alt="POWERJUMP"
                                                                                                 src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/PJ_white_98x36.png" ?>">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                    ...
                                                    <div class="clearfix buttonPosition">
                                                        <a href="#" class="button right"
                                                           id="continueStepConfirmPrograms">Continuar</a>
                                                    </div>
                                                </div>
                                                <!-- end of continueStepConfirmPrograms-->

                                                <div id="stepShowConfirmation" class="filter enrollmentStep"
                                                     style="display:none;">
                                                    <div class="filterFields clearfix">
                                                        <div class="left fieldsContainer">
                                                            ...
                                                            <div class="confirmed">Completaste el <span
                                                                    class="paymentMethodsFirstStep" style="color:red">1er paso</span>
                                                                <span class="paymentMethodsFirstStep">del</span> proceso
                                                                de inscripción al evento: <span
                                                                    class="eventTitle"></span>
                                                            </div>
...
Cualquier duda o consulta, entra en contacto con <a href="mailto:instructores@lesmillsarg.com">instructores@lesmillsarg.com</a> 
                                                ...
                                                <p class="nodisplay"><!-- end of stepShowConfirmation -->
                                            </div>
                                            <!-- end of in -->
                                        </div>
