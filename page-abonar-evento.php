...
$token = hash('ripemd160', $_GET['pId'] . $_GET['eId'] . $_GET['amnt'] . 'lMillsBody#33E');
	...
	<div id="content" class="site-content">
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-sm-8" style="float:none; margin: 0 auto;">
                ...
                <p><?= $_GET['desc'] ?> - $<?= $_GET['amnt'] ?></p>
                <p>Aguarde.... redireccionando al sitio de pago o visite el siguiente <a href="<?= $server ?>/paymentNotification/mercadoPagoEvento?eId=<?= $_GET['eId'] ?>&pId=<?= $_GET['pId'] ?>&amnt=<?= $_GET['amnt'] ?>&t=<?= $token ?>">enlace</a></p>


                <script>
                    location.href = "<?= $server ?>/paymentNotification/mercadoPagoEvento?eId=<?= $_GET['eId'] ?>&pId=<?= $_GET['pId'] ?>&amnt=<?= $_GET['amnt'] ?>&t=<?= $_GET['t'] ?>"
                </script>
