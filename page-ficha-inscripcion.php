...
wp_enqueue_script('eventos_inscripcion', get_stylesheet_directory_uri() . '/bodycontrol-integration/js/eventosInscripcion.js?v=5', array('jquery', 'base'));
					...
					<div class="content">
                                                <div class="inForm" method="get">
                                                    ...
                                                    <div id="stepInit" class="filter enrollmentStep" style="display:none;">
                                                        ...
                                                        <div class="clearfix buttonPosition"><a href="#" class="button" id="continueInit">Continuar</a>
                                                        </div>
                                                    ...
                                                    <div id="stepConfirmName" class="filter enrollmentStep" style="display:none;">
                                                        ...
                                                        <div class="clearfix buttonPosition">
                                                            <a href="#" class="button" id="cancelStepConfirmName">Cancelar</a><a href="#" class="button" id="continueStepConfirmName">Continuar</a>
                                                        </div>
                                                    ...
                                                    <div id="stepRegister" class="filter enrollmentStep" style="display:none;">
                                                        ...
                                                        <div class="clearfix buttonPosition">
                                                            <a href="#" class="button" id="continueStepRegister">Continuar</a>
                                                            <a href="#" class="button secondary" id="cancelStepRegister">Cancelar</a>
                                                        </div>
                                                    ...
                                                    <div id="stepConfirmGymName" class="filter enrollmentStep" style="display:none;">
                                                        ...
                                                        <div class="clearfix buttonPosition">
                                                            <a href="#" class="button" id="continueStepConfirmGymName">Continuar</a>
                                                        </div>
                                                    ...
                                                    <div id="stepValidateEmail" class="filter enrollmentStep" style="display:none;">
                                                        ...
                                                        <div class="clearfix buttonPosition">
                                                            <a href="#" class="button" id="continueStepValidateEmail">Continuar</a>
                                                        </div>
                                                    </div>
                                                        ...
                                                        <div class="filterFields clearfix">
                                                            <div class="left fieldsContainer">
                                                                <div>
                                                                    ...
                                                                    inscribirse en el Evento vía web. Por favor comuníquese
                                                                    con nosotros contactando a <a href="mailto:instructores@lesmillsarg.com">instructores@lesmillsarg.com</a>
                                                                </div>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div id="stepConfirmPrograms" class="filter enrollmentStep" style="display:none;">
                                                            ...
                                                            <div class="left fieldsContainer">
                                                                ...
                                                                <div class="programsContainer">
                                                                    ...
                                                                    <div id="stepConfirmProgamsSelections">
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BP" /><span id="code_BP" class="programCode"></span><img alt="BODYPUMP" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-pump.jpg" ?>"><span id="code_correlativa_BP" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BA" /><span id="code_BA" class="programCode"></span><img alt="BODYATTACK" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-attack.jpg" ?>"><span id="code_correlativa_BA" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BC" /><span id="code_BC" class="programCode"></span><img alt="BODYCOMBAT" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-combat.jpg" ?>"><span id="code_correlativa_BC" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BV" /><span id="code_BV" class="programCode"></span><img alt="BODYVIVE" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-vive.jpg" ?>"><span id="code_correlativa_BV" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BB" /><span id="code_BB" class="programCode"></span><img alt="BODYBALANCE" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-balance.jpg" ?>"><span id="code_correlativa_BB" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="RPM" /><span id="code_RPM" class="programCode"></span><img alt="RPM" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-rpm.jpg" ?>"><span id="code_correlativa_RPM" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BJ" /><span id="code_BJ" class="programCode"></span><img alt="BODYJAM" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-jam.jpg" ?>"><span id="code_correlativa_BJ" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="SH" /><span id="code_SH" class="programCode"></span><img alt="SH'BAM" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-shbam.jpg" ?>"><span id="code_correlativa_SH" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="BS" /><span id="code_BS" class="programCode"></span><img alt="BODYSTEP" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-step.jpg" ?>"><span id="code_correlativa_BS" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection" value="CX" /><span id="code_CX" class="programCode"></span><img alt="CXWORX" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/prog-cxworx.jpg" ?>"><span id="code_correlativa_CX" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                        <div><input type="checkbox" name="programSelection[]" class="programSelection pjSelection" value="PJ" /><span id="code_PJ" class="programCode"></span><img alt="POWERJUMP" src="<?php echo get_stylesheet_directory_uri() . "/bodycontrol-integration/images/PJ_white_98x36.png" ?>"><span id="code_correlativa_PJ" class="programError">Debes estar al días con tus actualizaciones para adquirir un nuevo mix</span>
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                        ...
                                                        <!-- end of filterFields-->
                                                        <div class="clearfix buttonPosition">
                                                            <a href="#" class="button" id="continueStepConfirmPrograms">Continuar</a>
                                                        </div>
                                                    </div>
                                                                ...
                                                                <div class="confirmed">
                                                                    <div>El <span style="color:red">3er paso</span>
                                                                        ...
                                                                        <div id="paypalSection">
                                                                            ...
                                                                            <div class="clearfix buttonPosition">
                                                                                <a id="paypalPoint" href="" class="button left">Pagar con PayPal</a>
                                                                            </div>
