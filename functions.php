 ...
 */
function orbisius_ct_lesmills_argentina_child_theme_enqueue_styles() {
	global $wp_styles;

    $parent_style = 'orbisius_ct_lesmills_argentina_parent_style';
    $parent_base_dir = 'onepress';
...
add_action( 'wp_enqueue_scripts', 'orbisius_ct_lesmills_argentina_child_theme_enqueue_styles', 25 );

function orbisius_ct_lesmills_argentina_example_function() {
    // put some code here
}