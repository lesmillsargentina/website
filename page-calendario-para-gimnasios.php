                                ...
                                <div class="entry-main">
                                    <div class="entry-content">
                                        ...
                                        <div class="none">
                                            ...
                                            <input id="configShowLesMillsCourse" type="hidden" value="true"/>
                                            <input id="configShowEverlast" type="hidden" value="false"/>
                                            <input id="configShowCore360" type="hidden" value="false"/>
                                        </div>
                                        <!-- configs -->
                                        <div class="staticContent calendario row"></div>
                                        <div class="content calendario row"></div>

                                        <div id="templates" style="display:none">
                                                <div class="col-12 col-md-3 tableContent lesMillsCourse calendarioItem text-center">
